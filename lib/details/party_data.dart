const Map<String, String> kCentroDestra = {
  ...
  'Sanità':
      '\u2022 Contrasto pandemia attraverso promozione comportamenti virtuosi e adeguamenti strutturali - come la ventilazione meccanica controllata e il potenziamento dei trasporti - senza compressione delle libertà individuali secondo il principio del convincere per non costringere',
  'Ambiente':
...
const Map<String, String> kTerzoPolo = {
  ...
  'Economia e Welfare':
      '\u2022 Zero tasse per giovani che avviano un\'attività imprenditoriale \n\u2022 Ripristinare e rafforzare Industria 4.0 (l\'evoluzione dell\'industria verso un modello "smart", dove gli strumenti di lavoro sono connessi alla Rete e interconnessi tra di loro) \n\u2022 Potenziare gli ITS investendo 1.5 miliardi',
  'Lavoro':
  ...
  'Fiscalità':
      '\u2022 Riforma IRPEF, abolizione IRAP e passaggio a sistema a due aliquote IVA (contro le quattro attualmente in vigore) \n\u2022 Riduzione tassazione del risparmio detassando completamente i redditi molto bassi “essenziali per vivere” \n\u2022 Grossi sgravi fiscali ai giovani: nessuna tassa fino ai 25 anni, ridotte del 50% fino ai 29',
  'Pensioni':
...
const Map<String, String> kMovimentoCinqueStelle = {
  ...
  'Economia e Welfare':
      '\u2022 Stabilizzazione del fondo centrale di garanzia per garantire liquidità alle PMI con garanzie statali dall\'80% al 100% \n\u2022 Introduzione di una serie di misure per rendere “più efficiente il sistema delle politiche attive” e un “monitoraggio delle misure anti-frode” (come?).',
  'Lavoro':
  ...
  'Sanità':
      '\u2022 Riforma titolo V della Costituzione per riportare la salute alla gestione diretta dello Stato, non più delle regioni \n\u2022 Aumento delle retribuzioni per il personale sanitario',
  'Ambiente':
      '\u2022 Stabilizzazione Superbonus (agevolazione fiscale per gli interventi di ristrutturazione che migliorano l\'efficienza energetica di case e condomini) \n\u2022 Diffusione di nuove tecnologie come le “smart road” (sistemi stradali interconnessi, per la riduzione del traffico e l\'aumento della sicurezza) \n\u2022 Cambio del parco auto con i modelli elettrici \n\u2022 Costruire impianti compatibili con richieste Europa e non inquinanti, per migliorare le prestazioni ambientali',
  'Diritti Civili':
      '\u2022 Ius scholae (riconoscimento della cittadinanza italiana a tutti quei minori stranieri, nati in Italia o che ci siano arrivati da bambini, che hanno completato uno o più cicli di studi) \n\u2022 Matrimonio egualitario \n\u2022 Necessità di approvare una legge contro l\'omobitransfobia',
};
...
const Map<String, String> kItalexit = {
  ...
  'Lavoro':
      '\u2022 Riduzione del cuneo fiscale e aumento dei salari \n\u2022 Revisione reddito di cittadinanza: chi lo riceve dovrà sempre rendersi disponibile a lavorare appena viene chiamato, anche con 24 ore di preavviso. Se rifiuterà 3 volte, perderà per sempre il reddito, come avviene in altri Paesi europei',
  'Fiscalità':
      '\u2022 Rottamazione cartelle fiscali ultimi 3 anni a chi ha sofferto enormemente a causa della pessima gestione della pandemia \n\u2022 Aliquota fissa del 15% a chi produce Made in Italy ',
  'Pensioni':
      '\u2022 Innalzamento delle pensioni minime a 900 euro \n\u2022 Abolizione legge Fornero',
  'Riforme':
      '\u2022 Riforma della giustizia \n\u2022 Modifica costituzionale per votare, attraverso referendum, anche in materia di trattati internazionalix',
  'Energia':
      '\u2022 Piano strategico a partire da competenze e risorse del Paese per rendersi il meno possibile vincolato a forniture esterne ',
  'Sanità':
...
const Map<String, String> kUnionePopolare = {
  ...
  'Lavoro':
      '\u2022 Innalzamento del reddito di cittadinanza da 780 a 1000 euro al mese \n\u2022 Introduzione salario minimo legale di almeno 10 euro lordi l’ora \n\u2022 Abolizione del Jobs Act (riforma del lavoro voluta dal Governo Renzi che introduce una serie di misure volte a rinnovare il mercato del lavoro)',
  'Fiscalità':
      'Riforma fiscale per ridurre le tasse ai redditi medi e bassi e aumentarle ai redditi alti, con stralcio e cancellazione riforma fiscale di Draghi \n\u2022 Introduzione tassa sul patrimonio partendo da soglia di 1 milione di euro e procedendo con aliquote in senso progressivo',
  'Pensioni':
      '\u2022 Innalzamento delle pensioni minime a 1000 euro \n\u2022 Abolizione legge Fornero per giungere all\'età pensionabile di 60 anni o 35 anni di contributi con tetto massimo alle pensioni alte',
  'Riforme': 'Non esiste una sezione dedicata nel programma elettorale',
  'Energia':
      '\u2022 Nazionalizzazione settore energetico a partire da Enel Green Power \n\u2022 Piano di investimenti straordinario nelle energie rinnovabili (almeno 10 GW di nuove installazioni l\'anno) \n\u2022 Per un\'economia circolare, equa e solidale, stop a inceneritori, fossile e nucleare  ',
  'Sanità':
